<%-- 
    ...
    Created on : 15-11-2018, 17:08:01
    Author     : matias
--%>
...
<html>
    <head>
        ...
        <script src="js/agregarAtencion.js"></script>
    </head>
    <body>
        <!-- Navegación -->
        <ul>
            ...
            <li><a href="agregarAtencion" class="active">Ingresar Atención</a></li>
        ...
        <!-- Formulario -->
        <h3>Ingreso de Atención</h3>
        <div>
            <form action="agregarAtencion" method="POST">
                <label for="dia">Día</label>
                <input type="number" name="dia" id="tx_dia">
                
                <label for="mes">Mes</label>
                <input type="number" name="mes" id="tx_mes">
                
                <label for="anio">Año</label>
                <input type="number" name="anio" id="tx_anio">
                ...
                <textarea name="descripcion" id="ta_descripcion"></textarea>
